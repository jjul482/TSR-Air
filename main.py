...
from helper import get_dataloader, check_device, get_num_nodes
from metrics import masked_mae
from transformer import Transformer
from graph_algo import load_graph_data
from args import get_public_config, str_to_bool
...
def main():
    ...
    model = Transformer(dropout=args.dropout,
    ...
    if args.stochastic_flag:
        from transformer_stochastic_trainer import Trainer
    else:
